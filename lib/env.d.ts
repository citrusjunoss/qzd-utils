declare type browserType = 'trident' | 'presto' | 'webKit' | 'gecko' | 'mobile' | 'ios' | 'android' | 'iPhone' | 'iPad' | 'webApp' | 'QQbrw' | 'weiXin' | 'QQ' | 'weiBo' | 'ucLowEnd' | 'ucweb' | 'ucSpecial' | 'webview' | 'Symbian' | 'ucSB' | 'qzd';
/**
