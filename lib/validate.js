...
exports.isObject = exports.isPINum = exports.isFlotNum = exports.isEmptyObj = exports.isEmpty = exports.isIDCard = exports.isQQ = exports.isTelephoneNumber = exports.isPhoneNumber = exports.validateEmail = exports.isDigital = exports.validatAlphabets = exports.validateUpperCase = exports.validateLowerCase = exports.validateURL = exports.vailPassword = void 0;
 ...
 */
function isFlotNum(str, num, count) {
    if (num === void 0) { num = 2; }
    if (count === void 0) { count = 1; }
    return new RegExp("^\\d{0," + num + "}([\\b]*|\\.|\\.\\d{0," + count + "}|$)$").test(str);
}
exports.isFlotNum = isFlotNum;
/**
 * 是否正整数
 * @param {*} num
 */
function isPINum(num) {
    var result = /^\+?[1-9][0-9]*$/.test(num);
    return result;
}
exports.isPINum = isPINum;
/**
 * @name 是否object
 * @param value
 *  * isObject({})
